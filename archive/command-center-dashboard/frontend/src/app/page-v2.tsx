...
const EnhancedDashboardV2 = dynamic(() => import('../components/EnhancedDashboard-v2'), { ssr: false });

export default function Dashboard() {
  const [currentTime, setCurrentTime] = useState(new Date());
  const [viewMode, setViewMode] = useState<'minimal' | 'enhanced'>('enhanced');
    ...
    return (
      <div className="relative">
        <button
          ...
          className="absolute top-4 right-4 z-50 px-3 py-1 bg-gray-800 border border-gray-500 text-white text-xs font-mono hover:border-white transition-colors"
        >
          [SWITCH TO MINIMAL]
        </button>
        <EnhancedDashboardV2 />
